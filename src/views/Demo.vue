...
<style lang="scss" >
  ...
  .v-window-x-transition-enter {
    ...
    .v-window-x-reverse-transition-enter-active,  .v-window-x-transition-enter-active, .v-window-y-reverse-transition-enter-active, .v-window-y-transition-enter-active{
      transition: 1s cubic-bezier(.25, .8, .5, 1);
    }
    .v-window-x-reverse-transition-leave-active, .v-window-x-transition-leave-active, .v-window-y-reverse-transition-leave-active, .v-window-y-transition-leave-active {
      transition: 1s cubic-bezier(.25, .8, .5, 1);
    }
    .gallery-wrapper {
      margin-top: -45px;
